// REEF Telegram bot — webhook + full setup via chat commands.
...
/link CODE — connect to your REEF account (basefish.netlify.app) (code from the Alerts tab); watches then sync both ways
/unlink — disconnect
/help — this message`;
